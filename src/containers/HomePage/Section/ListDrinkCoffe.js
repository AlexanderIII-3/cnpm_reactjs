...
class ListDrinkCoffe extends Component {
    constructor(props) {
        super(props);
        this.state = {
            arrDrink: []
    ...
    async componentDidUpdate(prevProps, prevState, snapshot) {
        if (prevProps.listTypeDrink !== this.props.listTypeDrink) {
            ...
            this.setState({
                arrDrink: this.props.listTypeDrink.resCoffe,
            })
        }

    }
    async componentDidMount() {
        this.props.fetchDrinkGastart('D2');
    }
            ...
            <div className='section-share  section-outstanding-doctor' >
                <div className='section-container'>
                    <div className='section-header'>
                        <span className='title-section'> Danh sách Cà Phê</span>
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(ListDrinkCoffe));
