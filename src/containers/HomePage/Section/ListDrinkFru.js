...
class ListDrinkFru extends Component {
    constructor(props) {
        super(props);
        this.state = {
            arrDrink: []
    ...
    async componentDidUpdate(prevProps, prevState, snapshot) {
        if (prevProps.listTypeDrink !== this.props.listTypeDrink) {
            ...
            this.setState({
                arrDrink: this.props.listTypeDrink.resFru,
            })
        }
            ...
            <div className='section-share  section-outstanding-doctor' >
                <div className='section-container'>
                    <div className='section-header'>
                        <span className='title-section'> Danh sách nước hoa quả</span>
...
const mapDispatchToProps = dispatch => {
    return {
        ...
        fetchDrinkGastart: (data) => dispatch(actions.fetchDrinkGastart(data))
    };
};

export default withRouter(connect(mapStateToProps, mapDispatchToProps)(ListDrinkFru));
